...
INSERT INTO users (id, created_at, email, first_name, is_account_non_expired, is_account_non_locked,
                   is_credentials_non_expired, is_enabled, updated_at, last_name, password, total_rating)
VALUES (1, NOW(), 'john.doe@example.com', 'John', TRUE, TRUE, TRUE, TRUE, NOW(), 'Doe', 'Password@123', 100),
...
VALUES (1, 'ABC123', NOW(), NOW() + INTERVAL '1 day', 1),
       (2, 'XYZ789', NOW(), NOW() + INTERVAL '1 day', 2);

-- Insert data into password_reset_tokens table
INSERT INTO password_reset_tokens (id, created_at, expires_at, token, user_id)
VALUES (1, NOW(), NOW() + INTERVAL '1 day', 'bsabs-fasvas-feaww', 1),
...
INSERT INTO test_cases (id, author_id, created_at, description, input_data, preconditions, project_id, steps, title,
                        updated_at, priority_id)
VALUES (1, 1, NOW(), 'Test Case 1 Description', 'Input Data 1', 'Preconditions 1', 1, ARRAY ['Step 1', 'Step 2'],
        'Test Case 1', NOW(), 1),
       (2, 2, NOW(), 'Test Case 2 Description', 'Input Data 2', 'Preconditions 2', 2, ARRAY ['Step 3', 'Step 4'],
        'Test Case 2', NOW(), 2);

-- Insert data into tests table
INSERT INTO tests (id, author_id, created_at, description, github_url, instructions, project_id, test_case_id, title,
                   updated_at, type_id)
VALUES (1, 1, NOW(), 'Test 1 Description', 'https://github.com/test1', 'Instructions 1', 1, 1, 'Test 1', NOW(), 1),
