...
public class ProjectStatus {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "project_statuses_id_gen")
    @SequenceGenerator(name = "project_statuses_id_gen", sequenceName = "project_statuses_id_seq", allocationSize = 1)
